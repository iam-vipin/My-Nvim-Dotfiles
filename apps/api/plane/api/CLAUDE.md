...
api/
├── middleware/
│   └── api_authentication.py    # APIKeyAuthentication class
├── permissions/
│   └── feature_flag.py          # Feature flag-based permissions
├── serializers/                 # Data serialization (18 files)
│   ├── base.py                  # BaseSerializer with field filtering & expansion
│   ├── issue.py                 # Issue/work-item serializers
│   ├── project.py               # Project serializers
│   ├── cycle.py                 # Cycle serializers
│   ├── module.py                # Module serializers
│   └── ...
├── views/                       # API endpoint handlers (18 files)
│   ├── base.py                  # BaseAPIView with auth, throttling
│   ├── issue.py                 # Work-item endpoints
│   ├── project.py               # Project endpoints
│   └── ...
├── urls/                        # URL routing (19 files)
├── rate_limit.py                # Rate throttling classes
