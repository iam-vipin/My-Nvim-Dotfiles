...
from plane.utils.notifications import WorkItemNotificationHandler, NotificationContext
from plane.utils.exception_logger import log_exception


@shared_task
def process_workitem_notifications(
    issue_id,
    project_id,
    actor_id,
    activities_data,
    ...
    try:
        ...
        activities = WorkItemNotificationHandler.parse_activities(activities_data)
