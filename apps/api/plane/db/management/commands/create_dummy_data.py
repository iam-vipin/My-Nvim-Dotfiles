...
class Command(BaseCommand):
    ...
    def workspace_create(self):
        ...
        return workspace.slug, creator, members

    def add_arguments(self, parser):
        # Positional argument
        parser.add_argument("--workspace_slug", type=str, nargs="?", help="Project ID")
    ...
    def handle(self, *args: Any, **options: Any) -> str | None:
        try:
            ...
            if not workspace_slug:
                # create workspace
                workspace_slug, creator, members = self.workspace_create()
            else:
                # Get workspace
