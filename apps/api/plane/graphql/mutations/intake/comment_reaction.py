...
@sync_to_async
def get_intake_work_item_comment_reactions_by_reaction(
...
@sync_to_async
def get_intake_work_item_comment_reaction(
    workspace_slug: str, project_id: str, comment_id: str, user_id: str, reaction: str
):
    try:
        project_teamspace_filter = project_member_filter_via_teamspaces(
...
class IntakeWorkItemCommentReactionMutation:
    ...
    async def add_intake_work_item_comment_reaction(
        ...
        comment_reaction = await get_intake_work_item_comment_reaction(
            workspace_slug=slug,
            project_id=project,
            comment_id=comment,
            user_id=user_id,
        ...
        comment_reactions = await get_intake_work_item_comment_reactions_by_reaction(
            workspace_slug=slug,
            project_id=project,
            comment_id=comment,
            user_id=user_id,
