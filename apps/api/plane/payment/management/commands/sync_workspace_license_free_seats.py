...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        schedule_workspace_license_free_seats.delay(batch_size=int(batch_size), batch_countdown=int(batch_countdown))

        # Print the success message
        self.stdout.write(self.style.SUCCESS("Successfully triggered the free seat sync task"))
        return
