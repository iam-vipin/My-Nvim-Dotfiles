...
export const RecurringWorkItemsProjectSettingsHeader = observer(function RecurringWorkItemssProjectSettingsHeader() {
  // translation
  const { t } = useTranslation();
  // derived values
  const settingsDetails = PROJECT_SETTINGS.recurring_work_items;
