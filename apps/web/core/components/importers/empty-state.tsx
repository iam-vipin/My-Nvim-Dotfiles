  ...
  return (
    <div className="flex h-full flex-col gap-10 rounded-xl">
      <div className="flex items-center border-b border-subtle py-3.5">
        <h3 className="text-18 font-medium">Imports</h3>
      </div>
      <div
      ...
      >
        <div className="relative flex flex-col justify-center gap-7 pl-8 lg:w-1/2">
          <div className="flex max-w-[26rem] flex-col gap-2">
            <h2 className="text-20 font-semibold">Imports are coming soon!</h2>
            <p className="text-14 font-medium text-tertiary break-keep">
