...
// local imports
import { FiltersRoot } from "../intake-filter";
import { InboxIssueAppliedFilters } from "../intake-filter/applied-filters/root";
import { InboxIssueList } from "./intake-list";
    ...
    <div className="bg-surface-1 flex-shrink-0 w-full h-full border-r border-strong ">
      <div className="relative w-full h-full flex flex-col overflow-hidden">
        <Header variant={EHeaderVariant.SECONDARY}>
          <div className="flex" data-tour="inbox-tour-step-1">
