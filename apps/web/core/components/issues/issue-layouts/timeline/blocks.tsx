...
export const WorkItemTimelineBlock = observer(function WorkItemTimelineBlock(props: Props) {
...
export const IssueTimelineSidebarBlock = observer(function IssueTimelineSidebarBlock(props: Props) {
  ...
  const { isMobile } = usePlatformOS();
  const storeType = useIssueStoreType() as TimelineStoreType;
