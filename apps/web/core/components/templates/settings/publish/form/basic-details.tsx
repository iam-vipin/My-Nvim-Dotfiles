...
} from "@/components/templates/settings/common";
...
export const TemplateBasicDetails = observer(function TemplateBasicDetails<T extends TBaseTemplateWithData>(
  props: TTemplateBasicDetailsProps<T>
) {
  ...
  return (
    <>
      ...
      <div className="space-y-1.5">
        <h3 className={COMMON_LABEL_TEXT_CLASS_NAME}>{t("templates.settings.form.publish.short_description.label")}</h3>
        <Controller
