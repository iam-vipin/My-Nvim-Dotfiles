...
function WorkspaceActiveCycleLoaderItem() {
  return (
    <div className="px-5 pt-5 last:pb-5">
      <div className="flex flex-col gap-4 p-4 rounded-xl border border-custom-border-200 bg-surface-1">
        <div className="flex items-center gap-1.5">
          <span className="size-7 bg-layer-1 rounded" />
          <span className="h-7 w-20 bg-layer-1 rounded" />
        </div>
        <div className="flex items-center justify-between px-3 py-2 rounded border-[0.5px] border-custom-border-100 bg-surface-2">
        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-2 xl:grid-cols-3">
          <span className="flex flex-col min-h-[17rem] border border-custom-border-200 rounded-lg bg-layer-1" />
          <span className="flex flex-col min-h-[17rem] border border-custom-border-200 rounded-lg bg-layer-1" />
          <span className="flex flex-col min-h-[17rem] border border-custom-border-200 rounded-lg bg-layer-1" />
        </div>
      </div>
