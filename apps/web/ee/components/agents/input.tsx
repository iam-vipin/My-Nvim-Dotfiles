...
export const AgentInput = observer(function AgentInput(props: Props) {
  const { editorRef, workspaceSlug, projectId, entityId, commentId, activityOperations, callback } = props;
  // translation
  ...
  const onSubmit = async (formData: Partial<TIssueComment>) => {
    try {
      ...
      // need to call the fetchRunActivities to fetch the latest states to start the polling
      callback?.();
    } catch (error) {
