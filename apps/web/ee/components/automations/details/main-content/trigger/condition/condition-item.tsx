...
export const AutomationDetailsMainContentTriggerConditionItem = observer(
  function AutomationDetailsMainContentTriggerConditionItem(
    props: FilterItemProps<TAutomationConditionFilterProperty, TAutomationConditionFilterExpression>
  ) {
    ...
    const selectedOperatorOption = config?.getDisplayOperatorByValue(
      condition.operator,
