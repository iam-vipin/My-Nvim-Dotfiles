...
// local imports
import { useWikiAppPowerKCreationCommands } from "./create-commands";

export const useWikiAppPowerKCommands = (): TPowerKCommandConfig[] => {
  const creationCommands = useWikiAppPowerKCreationCommands();
