...
export const TitleInput = observer(function TitleInput(props: TitleInputProps) {
  ...
  if (disabled) return <div className="text-20 font-semibold whitespace-pre-line">{title}</div>;
