...
export const RequestAttachmentsUploadItem = observer(function RequestAttachmentsUploadItem(props: Props) {
  // props
  ...
  return (
    <div className="flex items-center justify-between gap-3 h-11 bg-layer-1 pl-9 pr-2 pointer-events-none">
