export function DependencyLineSVG({ strokeColor }: { strokeColor: string }) {
  return (
    <svg className="w-4 h-full" xmlns="http://www.w3.org/2000/svg" viewBox={`0 0 4 50`} width={5} height={50}>
      <g>
        <path d="M0,0 L0,50" stroke={strokeColor} strokeWidth={`1.5`} fill="none" markerEnd={`url(#arrowhead)`} />
