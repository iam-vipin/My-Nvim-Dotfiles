...
import { TGithubEntityConnection, TIssueStateMap } from "@plane/types";
...
export const CreateProjectIssueSyncForm: FC<TCreateProjectIssueSyncForm> = observer((props) => {
  ...
  const existingGithubRepositoryIds = entityConnections
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            ...
            <SelectGithubRepository
              ...
              handleChange={handleProjectMapChange}
              isEnterprise={isEnterprise}
              excludeGithubRepositoryIds={existingGithubRepositoryIds}
            />
          </div>
