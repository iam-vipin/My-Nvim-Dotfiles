...
export interface IJiraStore extends IImporterBaseStore {
  // observables
...
export class JiraStore extends ImporterBaseStore implements IJiraStore {
  // observables
  ...
  constructor(public store: RootStore) {
    ...
    // store instances
    this.job = new ImporterJobStore<JiraConfig>(E_IMPORTER_KEYS.JIRA);
    this.auth = new JiraAuthStore(store);
    this.data = new JiraDataStore(store);
  }
