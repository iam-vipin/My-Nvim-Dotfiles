  ...
  initiatives: {
    ...
    empty_state: {
      ...
      search: {
        ...
        description:
          "Žádné iniciativy nebyly detekovány s odpovídajícími kritérii. \n Vytvořte novou iniciativu místo toho.",
      },
      not_found: {
      ...
      verified_domains: {
        ...
        verify_domain: {
          ...
          instructions: {
            ...
            step_2: "Vytvořte TXT záznam a vložte ověřovací kód.",
          ...
          verification_code_label: "Ověřovací kód",
          verification_code_description: "Přidejte tento TXT záznam do nastavení DNS",
          domain_label: "Doména",
