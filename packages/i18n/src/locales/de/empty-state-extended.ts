export default {
  ...
  workspace_empty_state: {
    ...
    teamspaces: {
      ...
      description: "Erstellen Sie eine dedizierte Oberfläche für jedes reale Team, getrennt von allen anderen Arbeitsoberflächen in Plane, und passen Sie sie an die Arbeitsweise Ihres Teams an.",
      cta_primary: "Neuen Teamspace erstellen",
    },
    initiatives: {
      title: "Verfolgen Sie Projekte und Epics von einem Ort aus",
      description: "Verwenden Sie Initiativen, um verwandte Projekte und Epics zu gruppieren und zu überwachen. Sehen Sie Fortschritt, Prioritäten und Ergebnisse—alles von einem einzigen Bildschirm aus.",
      cta_primary: "Initiative erstellen",
    },
    customers: {
      title: "Verwalten Sie Arbeit nach dem, was für Ihre Kunden wichtig ist",
      description: "Bringen Sie Kundenanfragen zu Arbeitselementen, weisen Sie Prioritäten nach Anfragen zu und fassen Sie Arbeitselementzustände in Kundendatensätzen zusammen. Bald werden Sie sich mit Ihrem CRM oder Support-Tool integrieren können für eine noch bessere Arbeitsverwaltung nach Kundenattributen.",
  ...
  settings_empty_state: {
    ...
    epic_setting: {
      ...
      description: "Gruppieren Sie verwandte Arbeitselemente in größere Einheiten, die sich über mehrere Zyklen und Module erstrecken - perfekt für die Verfolgung des Gesamtfortschritts.",
      cta_primary: "Aktivieren",
    },
    templates: {
