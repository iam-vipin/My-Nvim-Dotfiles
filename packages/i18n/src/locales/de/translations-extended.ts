  ...
  initiatives: {
    ...
    empty_state: {
      ...
      search: {
        ...
        description:
          "Keine Initiativen mit den passenden Kriterien gefunden. \n Erstellen Sie stattdessen eine neue Initiative.",
      },
      not_found: {
  ...
  dashboards: {
    ...
    empty_state: {
      ...
      widgets_list: {
        ...
        description:
          "Verwenden Sie Linien, Balken, Kreise und andere Formate, um Ihre Daten\nso zu sehen, wie Sie es von den angegebenen Quellen wünschen.",
      },
      widget_data: {
