  ...
  initiatives: {
    ...
    empty_state: {
      ...
      search: {
        ...
        description:
          "Aucune initiative détectée avec les critères correspondants. \n Créez plutôt une nouvelle initiative.",
      },
      not_found: {
  ...
  workspace_settings: {
    settings: {
      ...
      applications: {
        ...
        supported_plans_description: "Sélectionnez les plans d'espace de travail qui peuvent installer cette application. Laissez vide pour autoriser tous les plans.",
