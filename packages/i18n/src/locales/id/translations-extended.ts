export default {
  ...
  initiatives: {
    ...
    empty_state: {
      ...
      search: {
        ...
        description:
          "Tidak ada inisiatif yang terdeteksi dengan kriteria yang cocok. \n Buat inisiatif baru sebagai gantinya.",
      },
      not_found: {
  ...
  active_cycle_analytics: {
    empty_state: {
      ...
      assignee: {
        title:
          "Tambahkan penanggung jawab ke item kerja untuk melihat \n pembagian pekerjaan berdasarkan penanggung jawab.",
      },
      label: {
  ...
  dashboards: {
    ...
    empty_state: {
      ...
      widgets_list: {
        ...
        description:
          "Gunakan garis, bar, pai, dan format lainnya untuk melihat data Anda\nsesuai keinginan dari sumber yang Anda tentukan.",
      },
      widget_data: {
