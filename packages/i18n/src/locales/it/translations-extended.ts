export default {
  ...
  active_cycle_analytics: {
    empty_state: {
      ...
      assignee: {
        title:
          "Aggiungi assegnatari agli elementi di lavoro per vedere una \n distribuzione del lavoro per assegnatari.",
      },
      label: {
  ...
  workspace_settings: {
    settings: {
      ...
      applications: {
        ...
        supported_plans_description: "Seleziona i piani dell'area di lavoro che possono installare questa applicazione. Lascia vuoto per consentire tutti i piani.",
