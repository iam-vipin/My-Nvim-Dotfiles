...
export default {
  ...
  workspace_empty_state: {
    ...
    teamspaces: {
      ...
      description:
        "実世界のチームごとに専用のスペースを作成し、Planeの他のすべての作業スペースから分離して、チームの働き方に合わせてカスタマイズします。",
    ...
    customers: {
      ...
      description:
        "顧客のリクエストを作業項目に結び付け、リクエストごとに優先度を割り当て、作業項目の状態を顧客レコードにロールアップします。まもなく、CRMまたはサポートツールと統合して、顧客属性によるさらに優れた作業管理を実現できます。",
      cta_primary: "顧客レコードを作成",
    },
    dashboard: {
      title: "ダッシュボードで進捗を視覚化",
      description:
        "カスタマイズ可能なダッシュボードを構築して、メトリクスを追跡し、成果を測定し、インサイトを効果的に提示します。",
  ...
  settings_empty_state: {
    ...
    work_item_types: {
      ...
      description:
        "プロジェクト用の固有の作業項目タイプを定義します。各タイプには、プロジェクトとチームのニーズに合わせた独自のプロパティ、ワークフロー、フィールドを設定できます。",
      cta_primary: "有効化",
    },
    work_item_type_properties: {
      title:
        "この作業項目タイプに対してキャプチャするプロパティと詳細を定義します。プロジェクトのワークフローに合わせてカスタマイズします。",
      cta_secondary: "プロパティを追加",
    },
    epic_setting: {
      title: "エピックを有効化",
      description:
        "関連する作業項目を、複数のサイクルやモジュールにまたがる大きな単位にグループ化 — 全体像の進捗を追跡するのに最適です。",
      cta_primary: "有効化",
    },
    templates: {
