  ...
  dashboards: {
    ...
    empty_state: {
      ...
      widgets_list: {
        ...
        description:
          "Używaj linii, słupków, wykresów kołowych i innych formatów, aby zobaczyć swoje dane\nw sposób, jaki chcesz, z określonych przez Ciebie źródeł.",
      },
      widget_data: {
