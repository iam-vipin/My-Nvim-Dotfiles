  ...
  dashboards: {
    ...
    empty_state: {
      ...
      widgets_list: {
        ...
        description:
          "Folosește linii, bare, plăcinte și alte formate pentru a-ți vedea datele\nașa cum dorești din sursele pe care le specifici.",
      },
      widget_data: {
