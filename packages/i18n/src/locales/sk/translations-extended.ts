export default {
  ...
  initiatives: {
    ...
    empty_state: {
      ...
      search: {
        ...
        description:
          "Neboli zistené žiadne iniciatívy so zodpovedajúcimi kritériami. \n Namiesto toho vytvorte novú iniciatívu.",
      },
      not_found: {
  ...
  active_cycle_analytics: {
    empty_state: {
      ...
      assignee: {
        title:
          "Pridajte priradeným osobám pracovné položky, aby ste videli \n rozdelenie práce podľa priradených osôb.",
      },
      label: {
  ...
  workspace_settings: {
    settings: {
      ...
      applications: {
        ...
        supported_plans_description: "Vyberte plány pracovného priestoru, ktoré môžu nainštalovať túto aplikáciu. Ponechajte prázdne, ak chcete povoliť všetky plány.",
  ...
  dashboards: {
    ...
    empty_state: {
      ...
      widgets_list: {
        ...
        description:
          "Použite čiary, stĺpce, koláče a iné formáty na zobrazenie vašich dát\ntakým spôsobom, akým chcete, zo zdrojov, ktoré špecifikujete.",
      },
      widget_data: {
