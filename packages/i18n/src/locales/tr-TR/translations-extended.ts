  ...
  initiatives: {
    ...
    empty_state: {
      ...
      search: {
        ...
        description:
          "Eşleşen kriterlere sahip inisiyatif tespit edilmedi. \n Bunun yerine yeni bir inisiyatif oluşturun.",
      },
      not_found: {
      ...
      verified_domains: {
        ...
        verify_domain: {
          ...
          instructions: {
            ...
            step_2: "Bir TXT kaydı oluşturun ve doğrulama kodunu yapıştırın.",
          ...
          verification_code_description: "Bu TXT kaydını DNS ayarlarınıza ekleyin",
          domain_label: "Etki alanı",
