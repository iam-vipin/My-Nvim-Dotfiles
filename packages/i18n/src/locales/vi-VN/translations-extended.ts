  ...
  dashboards: {
    ...
    empty_state: {
      ...
      widgets_list: {
        ...
        description:
          "Sử dụng đường, cột, bánh tròn và các định dạng khác để xem dữ liệu của bạn\ntheo cách bạn muốn từ các nguồn bạn chỉ định.",
      },
      widget_data: {
