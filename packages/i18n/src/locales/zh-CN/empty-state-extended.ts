export default {
  ...
  workspace_empty_state: {
    ...
    teamspaces: {
      ...
      description: "为每个真实世界的团队创建专用空间,与 Plane 中的所有其他工作空间分离,并自定义它们以适应您的团队工作方式。",
    ...
    customers: {
      title: "按对客户重要的内容管理工作",
      description: "将客户请求与工作项关联,按请求分配优先级,并将工作项状态汇总到客户记录中。很快,您将能够与您的 CRM 或支持工具集成,以便按客户属性进行更好的工作管理。",
      cta_primary: "创建客户记录",
    },
    dashboard: {
      title: "使用仪表板可视化您的进度",
    ...
    wiki: {
      ...
      description: "页面是 Plane 中的思想捕捉空间。记录会议笔记,轻松格式化,嵌入工作项,使用组件库进行布局,并将它们全部保留在项目上下文中。",
      cta_primary: "创建您的页面",
    },
  },
  settings_empty_state: {
    ...
    work_item_types: {
      title: "创建和自定义工作项类型",
      description: "为项目定义独特的工作项类型。每种类型都可以有自己的属性、工作流程和字段 — 根据项目和团队需求量身定制。",
      cta_primary: "启用",
    },
