export default {
  ...
  workspace_empty_state: {
    ...
    teamspaces: {
      ...
      description: "為每個真實世界的團隊建立專用空間,與 Plane 中的所有其他工作空間分離,並自訂它們以適應您的團隊工作方式。",
    ...
    customers: {
      title: "按對客戶重要的內容管理工作",
      description: "將客戶請求與工作項關聯,按請求分配優先順序,並將工作項狀態彙總到客戶記錄中。很快,您將能夠與您的 CRM 或支援工具整合,以便按客戶屬性進行更好的工作管理。",
      cta_primary: "建立客戶記錄",
    },
    dashboard: {
      title: "使用儀表板視覺化您的進度",
    ...
    wiki: {
      ...
      description: "頁面是 Plane 中的思想捕捉空間。記錄會議筆記,輕鬆格式化,嵌入工作項,使用元件庫進行配置,並將它們全部保留在專案上下文中。",
      cta_primary: "建立您的頁面",
    },
  },
  settings_empty_state: {
    ...
    work_item_types: {
      title: "建立和自訂工作項類型",
      description: "為專案定義獨特的工作項類型。每種類型都可以有自己的屬性、工作流程和欄位 — 根據專案和團隊需求量身訂製。",
      cta_primary: "啟用",
    },
