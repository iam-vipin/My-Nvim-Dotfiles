...
export function PlaneIcon({ className = "text-current", ...rest }: ISvgIcons) {
  return (
    <svg viewBox="0 0 85 52" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest} className={className}>
      <path
