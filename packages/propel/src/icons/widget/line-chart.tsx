...
export function BasicLineChartIcon({ height = "24", width = "24", className = "", ...rest }: ISvgIcons) {
  return (
    <svg
      width={width}
      height={height}
...
export function MultiLineLineChartIcon({ height = "24", width = "24", className = "", ...rest }: ISvgIcons) {
  return (
    <svg
      width={width}
      height={height}
